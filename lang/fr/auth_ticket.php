...
/**
 * Lang file for auth Ticket plugin
 *
 * @package     auth_ticket
...
$string['configticketusessl'] = 'Si oui, le ticket est crypté/décrypté en utilisant les librairies openssl du système. Si non,
 c\'est la fonction d\'encryption interne de la base de données qui sera utilisée.';
...
$string['auth_ticketdescription'] = 'Ce mode d\'authentification permet à des utilisteurs ayant reçu une notification par
 courriel de se connecter directement sur leur compte sans passer par la page de login. Le ticket crypté leur ayant été
  transmis contient toutes les informations suffisantes de login pendant une certaine durée de temps de validité. Au delà
 de cette durée le ticket est perdu.';

$string['configshortvaliditydelay_desc'] = 'Durée de validité du ticket court (en secondes). Les tickets courts sont
 utilisés lorsque le délai de retour à Moodle à compter de la génération du ticket est connu comme étant court (retour immédiat
 ou synchrone).';

$string['configlongvaliditydelay_desc'] = 'Durée de validité du ticket long (en secondes). Les tickets longs sont utilisés
 lorsque le délai de retour à Moodle à compter de la génération du ticket est connu comme étant long (retour asynchrone), en
 général quelques jours.';

$string['configpersistantvaliditydelay_desc'] = 'La durée de persistance peut être illimitée (valeur 0), ou être réglée sur
 un nombre très grand de secondes. Notez des tickets persistants peuvent perdre leur validité si la méthode DSA (openssl)
 est utilisée en relation avec la valeur courante de la clef MNET.';
